                            ...
                            <div className="relative h-36 sm:h-48 md:h-64 overflow-hidden bg-navy/5">
                                {plan.image ? (
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-navy to-coral/20 flex flex-col items-center justify-center p-6 text-center gap-3">
                                        <MapPin className="w-8 h-8 sm:w-10 sm:h-10 text-white/20" />
                                        <span className="text-white/40 text-[9px] sm:text-[10px] font-black uppercase tracking-widest">Photo from Google Places</span>
                                    </div>
                                )}
